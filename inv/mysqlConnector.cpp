...
//	if (!(mysql_real_connect(&mysql, "localhost", "root", "may1024", "smallu", 0, NULL, 0))) //中间分别是主机，用户名，密码，数据库名，端口号（可以写默认0或者3306等），可以先写成参数再传进去
//	{
...
//bool QueryDatabase1()
//{
//	sprintf_s(query, "select * from student"); //执行查询语句，这里是查询所有，user是表名，不用加引号，用strcpy也可以
